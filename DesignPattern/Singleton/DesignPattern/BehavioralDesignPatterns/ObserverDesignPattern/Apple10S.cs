////------------------------------------------------------------------------
////<copyright file="Apple10S.cs" company="BridgeLabz">
////author="Bhushan"
////</copyright>
////-------------------------------------------------------------------------
namespace DesignPattern.BehavioralDesignPatterns.ObserverDesignPattern
{
    ...
    public class Apple10S : IProduct
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Apple10S"/> class.
        /// </summary>
