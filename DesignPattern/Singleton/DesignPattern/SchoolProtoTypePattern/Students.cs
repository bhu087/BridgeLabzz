////------------------------------------------------------------------------
////<copyright file="Students.cs" company="BridgeLabz">
////author="Bhushan"
////</copyright>
////-------------------------------------------------------------------------
namespace DesignPattern.SchoolProtoTypePattern
{
    ...
    public class Students : ISchoolInterface
    {
        /// <summary>
        /// The name
        /// </summary>
        ...
        {
            return "Student Name : " + this.name + ", Student City : " + this.city + ", Entry Time : " + this.entryTime;
        }
    }
}
